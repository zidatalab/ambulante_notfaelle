...
@Component({
  selector: 'app-render-trunk',
  templateUrl: './render-trunk.component.html',
  styleUrls: ['./render-trunk.component.scss']
})
export class RenderTrunkComponent implements OnInit {

  constructor(
    private db: DBService, private csv: CsvexportService,
